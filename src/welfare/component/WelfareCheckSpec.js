        ...
        <div className={styles.container}>
            ...
            <div className={styles["main-container"]}>
                ...
                <div className={styles["spec-container"]}>
                    ...
                    <input className={styles["spec-check"]} type="text" value="gdgd" readOnly />
                    <p className={styles["spec-info"]}>나이</p>
                    <input className={styles["spec-check"]} type="number" value="1234" readOnly />
                    <p className={styles["spec-info"]}>성별</p>
                    <input className={styles["spec-check"]} type="text" value="남성" readOnly />
                    <p className={styles["spec-info"]}>주소</p>
                    <input className={styles["spec-check"]} type="text" value="경기도 의왕시" readOnly />
                    <p className={styles["spec-info"]}>연락처</p>
                    <input className={styles["spec-check"]} type="text" value="010-2235-1234" readOnly />

                    <p className={styles["spec-info"]}>신체</p>
                    <input className={styles["spec-check-hw"]} type="number" placeholder="175" readOnly />
                    <span className={styles.hw}>cm</span>
                    <input className={styles["spec-check-hw"]} type="number" placeholder="180" readOnly />
                    <span className={styles.hw}>kg</span>

                    <p className={styles["spec-info"]}>질병</p>
                    <input className={`${styles["spec-check"]} ${styles.disease}`} type="text" value="감기" readOnly />
                </div>
