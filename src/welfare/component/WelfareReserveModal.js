    ...
    <div className="container">
      <div className="main-container">
        <div className="main-section" id="modal-container">
          ...
          <hr />
          <div id="reserve-info-container1">
            <span className="reserve-info-text">날짜</span>
            <input
              id="insert-date"
              type="date"
              value={today}
          ...
          <div id="reserve-info-container2">
            <span className="reserve-info-text">시간</span>
          ...
          <hr />
          <div id="reserve-info-container3">
            <span className="reserve-price-text">요금</span>
            <span id="price">60,000 원</span>
          </div>
